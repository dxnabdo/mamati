...
export default function PhoneRegisterPopup() {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!validatePhone(phone))
      return setMessage("رقم الهاتف يجب أن يكون أرقام فقط (10-15 رقم)");
  ...
  return (
    ...
    >
      <div
        className="bg-white rounded-2xl p-6 w-[90%] max-w-md relative shadow-2xl"
        onClick={(e) => e.stopPropagation()}
      >
        <button
          onClick={closePopup}
          className="absolute top-3 left-3 text-3xl text-black hover:opacity-70"
        >
          ✕
        </button>
        ...
        <div className="text-center">
          ...
          <h2 className="text-2xl font-bold text-gray-800 mb-2">
            متجر ماماتي للملابس الأوروبية
          </h2>

          <p className="text-lg text-orange-500 font-semibold mb-3">
            🔥 دخل رقمك وكون أول من يتوصل بالجديد قبل ما يسالي
          </p>
